...
a = Analysis([electrum+ MAIN_SCRIPT,
              electrum+'electrum_bcx/gui/qt/main_window.py',
              electrum+'electrum_bcx/gui/text.py',
              electrum+'electrum_bcx/util.py',
              electrum+'electrum_bcx/wallet.py',
              electrum+'electrum_bcx/simple_config.py',
              electrum+'electrum_bcx/bitcoin.py',
              electrum+'electrum_bcx/dnssec.py',
              electrum+'electrum_bcx/commands.py',
              electrum+'electrum_bcx/plugins/cosigner_pool/qt.py',
              electrum+'electrum_bcx/plugins/email_requests/qt.py',
              electrum+'electrum_bcx/plugins/trezor/qt.py',
              electrum+'electrum_bcx/plugins/safe_t/client.py',
              electrum+'electrum_bcx/plugins/safe_t/qt.py',
              electrum+'electrum_bcx/plugins/keepkey/qt.py',
              electrum+'electrum_bcx/plugins/ledger/qt.py',
              electrum+'electrum_bcx/plugins/coldcard/qt.py',
              ],
             binaries=binaries,
             datas=datas,
